    ...
    <div style={{ backgroundColor: "var(--bg)", minHeight: "100vh", fontFamily: "Inter, system-ui, sans-serif" }}>
      ...
      <header style={{
        ...
        <div style={{ maxWidth: "640px", margin: "0 auto", padding: "0 20px", height: "52px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <span style={{ fontFamily: "Syne, system-ui, sans-serif", fontWeight: 800, fontSize: "20px", letterSpacing: "-0.5px", color: "var(--text)" }}>Karakteren</span>
          <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
            <Link href="/login" style={{ fontFamily: "Inter, system-ui, sans-serif", fontWeight: 600, fontSize: "14px", color: "var(--text-muted)", textDecoration: "none", padding: "8px 12px" }}>
              Logg inn
            </Link>
      ...
      <section style={{ maxWidth: "640px", margin: "0 auto", padding: "40px 20px 48px", textAlign: "center" }}>
        ...
        <div style={{
          ...
          <span style={{ position: "absolute", top: "-12px", left: "50%", transform: "translateX(-50%)", backgroundColor: "var(--surface)", border: "1px solid var(--border)", borderRadius: "50%", width: "22px", height: "22px", display: "flex", alignItems: "center", justifyContent: "center" }}>
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="var(--text-muted)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
          </span>
        ...
        <div style={{ maxWidth: "640px", margin: "0 auto", padding: "20px", display: "flex", justifyContent: "space-around" }}>
          {[["10", "fag"], ["1–6", "karakter"], ["gratis", "å starte"]].map(([val, lbl]) => (
            <div key={lbl} style={{ textAlign: "center" }}>
              <div style={{ fontFamily: "Syne, system-ui, sans-serif", fontWeight: 800, fontSize: "22px", color: "var(--text)" }}>{val}</div>
      ...
      <section style={{ maxWidth: "640px", margin: "0 auto", padding: "36px 20px" }}>
        <h2 style={{ fontFamily: "Syne, system-ui, sans-serif", fontWeight: 700, fontSize: "20px", letterSpacing: "-0.3px", marginBottom: "24px", color: "var(--text)" }}>
      ...
      <div style={{ backgroundColor: "var(--bg-alt)", borderTop: "1px solid var(--border)" }}>
        <div style={{ maxWidth: "640px", margin: "0 auto", padding: "32px 20px 56px", textAlign: "center" }}>
          <h2 style={{ fontFamily: "Syne, system-ui, sans-serif", fontWeight: 700, fontSize: "20px", marginBottom: "8px", color: "var(--text)" }}>
            Klar for en prøve?
          </h2>
